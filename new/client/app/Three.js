 ...
 * @author mrdoob / http://mrdoob.com/
 */
THREE.STLExporterMesh = function () {};

THREE.STLExporterMesh.prototype = {

	constructor: THREE.STLExporterMesh,
...
// THREE.saveSTL = function () {};
//
// THREE.saveSTL.prototype = {
...
THREE.saveSTLAscii = function (scene, name) {
	var exporter = new THREE.STLExporterMesh();
    var stlString = exporter.parse( scene );
	...
	tempLink.setAttribute('download', name + '.stl');
	tempLink.click();

    // saveAs(blob, name + '.stl');
};

THREE.saveSTLBinary = function (scene, name) {
